...
export default function Artist({ artist, onPlay }) {
  ...
  const playAlbum = (album) => {
    ...
    playSong(albumSong || displayedSongs[0]);
  };
            ...
            <div className="relative z-10 flex flex-col lg:flex-row">
              <div className="relative flex shrink-0 items-center justify-center p-5 sm:p-7 lg:w-[390px] lg:p-8">
                ...
                >
                  ...
                  >
                    <BadgeCheck
                      size={15}
                      className="fill-green-400 text-black shrink-0"
                    />
                  ...
                  >
                    <Disc3 size={20} className="shrink-0" />
                  </motion.div>
                ...
                >
                  <Music2 size={19} className="shrink-0" />
                </motion.div>
              </div>
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center px-5 pb-7 sm:px-7 sm:pb-8 lg:px-3 lg:py-10 lg:pr-10">
                ...
                <motion.h1
                  ...
                  className="max-w-4xl break-words text-4xl font-black tracking-tight text-white sm:text-6xl lg:text-7xl"
                >
                  {artistName}
                </motion.h1>
                ...
                <div className="mt-7 grid grid-cols-3 gap-2 sm:flex sm:flex-wrap sm:gap-3">
                  {[
                    ...
                    [artistAlbums.length + singles.length, "Releases"],
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="group/play relative flex items-center justify-center gap-2 overflow-hidden rounded-full bg-green-400 px-7 py-3.5 font-bold text-black shadow-[0_15px_50px_rgba(34,197,94,0.25)]"
                  >
                    <motion.span
                      initial={{
                        x: "-120%",
                      ...
                      className="pointer-events-none absolute inset-0 skew-x-[-20deg] bg-white/30"
                    />
                  ...
                  <motion.button
                    ...
                    className={`group/follow relative flex items-center justify-center gap-2.5 overflow-hidden rounded-full border px-6 py-3.5 text-sm font-semibold backdrop-blur-xl transition-all duration-300 ${
                      following
                        ? "border-green-400/40 bg-green-400/10 text-green-400 shadow-[0_12px_35px_rgba(34,197,94,0.18)]"
                  ...
                  >
                    ...
                    <span className="relative z-20 flex h-5 w-5 min-h-[20px] min-w-[20px] items-center justify-center shrink-0">
                      {following ? (
                        <UserCheck
                          key="user-check"
                          size={18}
                        ...
                        <UserPlus
                          ...
                          size={18}
                          strokeWidth={2.5}
                          className="h-5 w-5 text-white shrink-0 group-hover/follow:text-green-400 transition-colors"
                        />
                      )}
                    </span>

                    <span className="relative z-20 select-none font-semibold">
                    ...
                    {following && (
                      <motion.span
                        ...
                        className="relative z-20 h-2 w-2 min-h-[8px] min-w-[8px] rounded-full bg-green-400 shadow-[0_0_12px_rgba(74,222,128,0.9)]"
                      />
                    )}
                  </motion.button>
                  ...
                  <motion.button
                    ...
                    className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-zinc-400 backdrop-blur-xl transition-colors hover:text-white shrink-0"
                  >
          ...
          {displayedSongs.map((song, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex min-w-0 items-center gap-2.5 overflow-hidden rounded-2xl border border-white/[0.06] bg-[#080b0a] p-3 text-left transition-colors duration-300 hover:border-green-400/20 hover:bg-[#0c120f] sm:gap-3"
              >
                <motion.span
                  initial={{
                    x: "-130%",
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 transition group-hover:opacity-100">
                    <span className="flex h-8 w-8 items-center justify-center rounded-full bg-green-400 text-black shadow-[0_0_25px_rgba(74,222,128,.45)]">
                      <Play
                        size={14}
                        fill="currentColor"
                        className="shrink-0"
                ...
                >
                  <h3 className="truncate text-sm font-bold text-white transition-colors group-hover:text-green-400 sm:text-base">
                    {song.title}
                  </h3>
                ...
                <motion.button
                  ...
                  className={`relative z-20 flex h-9 w-9 shrink-0 items-center justify-center rounded-full transition ${
                    isLiked
            ...
            {artistAlbums.map((album, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <Disc3 size={18} className="shrink-0" />
                  </motion.div>
                  ...
                  <motion.button
                    ...
                    className="absolute bottom-3 right-3 flex h-11 w-11 items-center justify-center rounded-full bg-green-400 text-black opacity-0 shadow-[0_0_30px_rgba(74,222,128,.4)] transition-opacity duration-300 group-hover:opacity-100"
                  >
                    <Play
                      size={17}
                      fill="currentColor"
                ...
                >
                  <h4 className="truncate font-black text-white transition-colors group-hover:text-green-400">
                    {album.title}
                  </h4>
          ...
          >
            {singles.map((song, index) => (
              <motion.button
                ...
                className="group relative overflow-hidden rounded-2xl border border-white/[0.07] bg-[#080b0a] p-3 text-left shadow-xl"
              >
                ...
                >
                  ...
                  <motion.span
                    ...
                    className="absolute bottom-3 right-3 flex h-11 w-11 items-center justify-center rounded-full bg-green-400 text-black shadow-[0_0_30px_rgba(74,222,128,.4)] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                  >
                    <Play
                      size={17}
                      fill="currentColor"
